export const environment = {
    production: true,
    hmr: false,
    apiUrl: 'https://sandbox-api2.g99.vn/api',
    apiTelecomUrl: 'https://sandbox-admin2.g99.vn/telecom/api',
    apiGtalkUrl: 'https://sandbox-admin2.g99.vn/virtual-number/api',
    apiGipUrl: 'http://localhost:4000/gip/api',
    apiProductPrivate: 'http://172.16.252.11:3001/api',
    apiTelecomOraclePrivate: 'http://172.16.252.16:3990/api',
