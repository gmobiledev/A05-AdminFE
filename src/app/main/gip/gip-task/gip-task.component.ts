...
@Component({
  selector: 'app-gip-task',
  templateUrl: './gip-task.component.html',
  styleUrls: ['./gip-task.component.scss']
})

export class GipTaskComponent implements OnInit {
  ...
  onSubmitSearch(): void {
    this.router.navigate(['gip/task'], { queryParams: {keyword: this.searchForm.keyword, status: this.searchForm.status}})
  }
