...
export class InventoryService {
  ...
  reportTongHopSimByAdmin(params) {
    return this._http.get<any>(`${environment.apiUrl}/admin/mcs/telecom-oracle/report/s99-msisdn-state-by-admin`, {params: params});
  }
  ...
  exportAssignedNumbersExcel(params: any): Observable<any> {
    return this._http.get(`${environment.apiUrl}/admin/inventory/a05/export-assigned-numbers`, {
      params,
      observe: 'response',
      responseType: 'blob'
    });
  ...
  getAssignedNumbers(params) {
    return this._http.get<any>(`${environment.apiUrl}/admin/inventory/a05/assigned-numbers`, { params: params });
  }

  getAllUnits(params: any = null) {
    return this._http.get<any>(`${environment.apiUrl}/admin/task/unit`);
  }
}